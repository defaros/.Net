    ...
    class XML
    {
        ...
        public MSG WriteXml(MSG oMsg)
        {
            try
            {
                ...
                document.Save(@"C:\Users\Wanted\Documents\Visual Studio 2010\Projects\ways\ConfigSqlServer.xml");
            }
            catch (Exception e)
            {
        ...
        public MSG ReadXml(MSG oMsg)
        {
            try
            {
                ...
                XDocument document = XDocument.Load(@"C:\Users\Wanted\Documents\Visual Studio 2010\Projects\ways\ConfigSqlServer.xml");
        ...
        public MSG WriteSmtpXml(MSG oMsg)
        {
            try
            {
                ...
                document.Save(@"C:\Users\Wanted\Documents\Visual Studio 2010\Projects\ways\ConfigSMTP.xml");
            }
            catch (Exception e)
            {
                MessageBox.Show("ERREUR:\n" + e.Message);
        ...
        public MSG ReadSmtpXml(MSG oMsg)
        {
            try
            {
                ...
                // Charge le fichier XML de config
                XDocument document = XDocument.Load(@"C:\Users\Wanted\Documents\Visual Studio 2010\Projects\ways\ConfigSMTP.xml");
