...
namespace ways.Couche_middleware._91___Service_etendu.Composant_accès_aux_données
{
    class CAD
    {
        ...
        /* Fonction qui récupère la config XML de SQL server et ouvre le connexion à la base de données */
